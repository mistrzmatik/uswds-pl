# Polskie tłumaczenie/lokalizacja United States Web Design System

Zmiany obejmują tylko poniższe komponenty:
- [CharacterCount](https://designsystem.digital.gov/components/character-count/): Tłumaczenia tekstów
- [ComboBox](https://designsystem.digital.gov/components/character-count/): Tłumaczenia tekstów
- [DatePicker](https://designsystem.digital.gov/components/date-picker/): Tłumaczenia tesktów, zmiana formatu daty na YYYY-MM-DD, zmiana pierwszego dnia tygodnia na poniedziałek
- [FileInput](https://designsystem.digital.gov/components/file-input/): Tłumaczenia tekstów
- [TimePicker](https://designsystem.digital.gov/components/time-picker/): Zmiana formatu czasu na 24-godzinny
